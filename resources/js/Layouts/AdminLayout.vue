...
const moreNavItems = [
    ...
    {
        label: 'Workouts',
        routeName: 'admin.workouts.index',
        icon: `<path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3.75h10.5a3 3 0 0 1 3 3v10.5a3 3 0 0 1-3 3H6.75a3 3 0 0 1-3-3V6.75a3 3 0 0 1 3-3Z" /><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 9.75h7.5M8.25 14.25h4.5" />`,
    },
    {
        label: 'Performance',
        routeName: 'admin.performance.index',
        icon: `<path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75Z" /><path stroke-linecap="round" stroke-linejoin="round" d="M12 3.75a8.25 8.25 0 0 1 8.25 8.25M12 12l4.5-3" />`,
    },
    {
        label: 'System',
        routeName: 'admin.system.index',
            ...
            >
                ...
                <nav class="px-3 py-3 space-y-0.5">
                    ...
                    >
                        ...
                        <span class="font-semibold">Zurück zur App</span>
                    </Link>
                </nav>
